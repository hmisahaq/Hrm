                    ...
                    <?= form_open('loan/Loan/create_installment') ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                 ...
                                 <?php echo form_dropdown('employee_id',$gndloan,(!empty($example->employee_id)?$example->employee_id:null), 'class="form-control"  id="employee_id" onchange="SelectToLoad(this.value),SelectToname(this.value),SelectAuto(this.value)" style="width:400px"') ?>
                            </div>
                        </div>
                        <div class="form-group row">
