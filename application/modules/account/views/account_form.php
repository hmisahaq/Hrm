...
<?php echo display('add_account') ?>
</button> 
<?php endif; ?>
<?php if($this->permission->method('account','read')->access()): ?>
<a href="<?php echo base_url();?>/account/Account_controller/accountView" class="btn btn-primary"><?php echo display('manage_account') ?></a>
<?php endif; ?>
</div>
   <div class="row">
    <!--  table area -->
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header" style="background-color:green; color: white">
                ...
                <center><strong><?php echo display('add_new_account') ?></strong></center>
            </div>
            ...
            <div class="panel">
                ...
                <div class="panel-body">
                    ...
                    <?= form_open('account/Account_controller/create_account') ?>
                        ...
                        <div class="form-group row">
                            <div for="account_type" class="col-sm-4 col-form-div"><?php echo display('account_type') ?> *</div>
                            <div class="col-sm-8">
